    ...
    <div className="container service_box_deail blog_page_card">
      <div className="row">
                ...
                <div className="row mb-4" key={index}>
                  {cardData.slice(index * 2, index * 2 + 2).map((card) => (
                    <div key={card.id} className="col-lg-6">
                      {/* <div className="why-feature  bottomReverse_cutPiece"> */}
        ...
        <div className="col-lg-3 mt-3 right_section_blog ">
          ...
          <div className="card border-0 shadow-sm  mb-5 bhjhg cutPieceRight">
          ...
          {/* <!-- Tag Cloud Card --> */}
          <div className="card border-0 shadow-sm mb-4 tag_cloud cutPieceRight">
            <div className="side_up_icon icon_one">
              {/* <svg
                className="w-6 h-6 text-gray-800 dark:text-white"
                aria-hidden="true"
